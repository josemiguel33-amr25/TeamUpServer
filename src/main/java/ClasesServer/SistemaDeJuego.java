...
public class SistemaDeJuego {
    ...
    public String comprarArticulo(int idUsuario, int idArticuloElementoMercado) {
        return MercadoManager.getMercadoManager().comprarArticulo(idUsuario, idArticuloElementoMercado, sv.getBaseDatosManager());
    }

    public String ponerArticuloVenta(int idUsuario, int idCosmetico, int precio) {
        return MercadoManager.getMercadoManager().ponerArticuloVenta(idUsuario, idCosmetico, precio,sv.getBaseDatosManager());
    }

    public String obtenerMisElementosMercado(int idUsuario) {
        return MercadoManager.getMercadoManager().obtenerElementosUsuarioMercado(idUsuario, sv.getBaseDatosManager());
    }

    public String quitarArticuloMercado(int idUsuario, int idArticuloMercado) {
        return MercadoManager.getMercadoManager().quitarArticuloMercado(idUsuario, idArticuloMercado, sv.getBaseDatosManager());
    }

    public String obtenerElementosMercado() {
        return MercadoManager.getMercadoManager().obtenerElementosMercado(sv.getBaseDatosManager());
    }

    public String abrirSobre(int idUsuario, String nombreSobre) {
        return CosmeticoManager.getCosmeticoManager().abrirSobre(idUsuario, nombreSobre, sv.getBaseDatosManager());
    }

    public String cambiarCosmetico(int idUsuario, int idCosmetico) {
        return CosmeticoManager.getCosmeticoManager().cambiarCosmetico(idUsuario, idCosmetico, sv.getBaseDatosManager());
    }

    public String verSobres(int idUsuario, String tipo) {
        return CosmeticoManager.getCosmeticoManager().verSobres(idUsuario, tipo, sv.getBaseDatosManager());
    }

    public String comprarSobre(int idUsuario, String nombreSobre) {
        return CosmeticoManager.getCosmeticoManager().comprarSobre(idUsuario, nombreSobre, sv.getBaseDatosManager());
    }

    public String recogerRecompensa(int idUsuario, int idPartido) {
        return PartidosManager.getPartidosManager().recogerRecompensas(idUsuario, idPartido, sv.getBaseDatosManager());
    }

    public String votarJugadores(int idUsuario, int idPartido, List<VotacionJugador> votaciones, String equipoGanador) {
        return PartidosManager.getPartidosManager().votarJugadores(idUsuario, idPartido, votaciones, equipoGanador, sv.getBaseDatosManager());
    }

    public String partidoFinalizado(int idUsuario, int idPartido ) {
        return PartidosManager.getPartidosManager().partidoFinalizado(idUsuario,  idPartido, sv.getBaseDatosManager());
    }
    ...
    public String verMisPartidos(int idUsuario,  String estado) {
        ...
        return PartidosManager.getPartidosManager().obtenerPartidosUsuario(idUsuario,  estado, sv.getBaseDatosManager());
    }

    public String verMasInfoUsuario(int idUsuario) {
        return UsuarioManager.getUsuarioManager().verPerfilJugador(idUsuario, sv.getBaseDatosManager());
    }

    public String verMasInfoPartido(int idPartido) {
        return PartidosManager.getPartidosManager().verMasInfoPartido(idPartido, sv.getBaseDatosManager());
    }

    public String unirsePartido(int idUsuario, int idPartido, String equipo) {
        return PartidosManager.getPartidosManager().unirsePartido(idUsuario, idPartido, equipo, sv.getBaseDatosManager());
    }

    public String abandonarPartido(int idUsuario, int idPartido) {
        return PartidosManager.getPartidosManager().abandonarPartido(idUsuario, idPartido, sv.getBaseDatosManager());
    }
    ...
    public String partidosPrimeraCarga(String ciudad, String soloverificados) {
        ...
        return PartidosManager.getPartidosManager().obtenerPartidos(ciudad, soloverificados, sv.getBaseDatosManager());
    }

    public String crearPartido(Map<String,String> mapaDatos, JugadorSistema j) {
        return PartidosManager.getPartidosManager().registarPartido(mapaDatos, j, sv.getBaseDatosManager());
    }
    ...
    public String obtenerRanking(String rangoFiltro, String mayorMenor) { // rango filtro el numero del rango 1-4 y si es mayor o menor (mayor/menor)
        return RankingManager.getRankingManager().obtenerListaJugadoresRango(rangoFiltro, mayorMenor, sv.getBaseDatosManager());
    }

    public String obtenerInventarioJugador(int idUsuario) {
        return UsuarioManager.getUsuarioManager().obtenerInventarioUsuario(idUsuario, sv.getBaseDatosManager());
    }
