...
public class Servidor {
    public static final int JUGADORES_MAXIMO = 14; //Estamos hablando de que mi app gira en torno a partidos de futbol 7 (7 + 7), jugadores maximos por partido
            ...
            while (true) {
                ...
                while (true) {
                    try {
                        ...
                        System.out.println("TeamUp|MensajeInterno|Jugador conectado");
